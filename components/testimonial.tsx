...
const testimonials = [
  ...
  },
  {
    ...
    role: "@marytcampos",
    content: "Nos encantó la experiencia!! 100% recomendado ❤️❤️",
  },
  {
    id: 3,
    ...
    <section id="testimonios" className="py-20 md:py-32  text-content-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <Card
            className="bg-primary-50 backdrop-blur-sm border-none"
            shadow="none"
          >
              ...
              <div className="text-center pt-8">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="opacity-100 text-success-700 text-center">
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${
                  index === current ? "bg-foreground w-6" : "bg-foreground/40"
                }`}
